...
public class NewProductsPreview {
	
	
	
	

	private void repaint(S8WebFront front) {

	
		List<WorkspaceGridCard> cards = new ArrayList<>();
		
		String pic0 = "alpha-ubiplant/assets/cards/turbine-pic.png";
